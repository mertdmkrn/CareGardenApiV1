...
namespace CareGardenApiV1.Controller
{
    ...
    //                business.telephone = "+9" + htmlDoc.DocumentNode.SelectSingleNode("//a[@id='mobil-callcenter-number']")?.Attributes["href"]?.Value.Replace("tel://", "") ?? "5000000000";
    ...
    //        if (name.ToLower().Contains("oje") || name.ToLower().Contains("el"))
    //        {
    //            return new Guid("4753fd7f-5e76-4d10-982b-5d2bca1b6f1a");
    //        }

    //        if (name.ToLower().Contains("cilt") || name.ToLower().Contains("dudak") || name.ToLower().Contains("bakım"))
    //        {
